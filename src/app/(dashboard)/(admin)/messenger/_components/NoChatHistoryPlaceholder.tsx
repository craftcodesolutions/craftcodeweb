...
const NoChatHistoryPlaceholder = React.memo(({ name }: NoChatHistoryPlaceholderProps) => {
NoChatHistoryPlaceholder.displayName = 'NoChatHistoryPlaceholder';
  // Stabilize the name to prevent re-renders
  const displayName = name || "User";

  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-6 animate-in fade-in duration-300">
